...
const RABE3_I18N = {
  en: {
    ...
    hero_headline: "Your Quran journey, beautifully calm.",
    hero_sub: "Read with focus. Practice with guidance. Live each day closer to the Book — without noise, ads, or compromise.",
    ...
    why_eyebrow: "Why Rabe3 Al-Quloob", why_title: "Built for presence, not distraction.",
    ...
    exp_kids_eyebrow: "Kids adventure", exp_kids_title: "Where young hearts meet the Quran.",
  ...
  ar: {
    ...
    hero_headline: "رحلتك مع القرآن، بهدوءٍ جميل.",
    hero_sub: "اقرأ بتركيز. تدرّب بتوجيه. عِش كل يوم أقرب إلى الكتاب — بلا ضجيج، بلا إعلانات، بلا تنازلات.",
    ...
    why_eyebrow: "لماذا ربيع القلوب", why_title: "صُمم للحضور، لا للتشتيت.",
    ...
    exp_kids_eyebrow: "مغامرة الأطفال", exp_kids_title: "حيث تلتقي القلوب الصغيرة بالقرآن.",
